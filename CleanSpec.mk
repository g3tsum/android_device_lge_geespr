...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/system/build.prop)
...
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/system/build.prop)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/geespr/obj/EXECUTABLES/mm-vdec-omx-test*_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/symbols/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/system/bin/mm-vdec-omx-test*)
$(call add-clean-step, rm -rf $(OUT_DIR)/target/product/geespr/obj/EXECUTABLES/charger_touch_intermediates)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/symbols/system/bin/charger_touch)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/system/bin/charger_touch)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/obj/NOTICE_FILES/src/system/bin/charger_touch.txt)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/recovery/root/default.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/system/build.prop)
$(call add-clean-step, rm -f $(OUT_DIR)/target/product/geespr/root/default.prop)
